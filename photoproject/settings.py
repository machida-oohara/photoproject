...
# お使いのものを入力してください
DEFAULT_FROM_EMAIL = 'katsunori.mikami@mail.o-hara.ac.jp'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'smtp-mail.outlook.com'            # GmailのSMPTサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = 'katsunori.mikami@mail.o-hara.ac.jp'     # Gmailのアドレスを入力
EMAIL_HOST_PASSWORD = '1977*Mikami' # Gmailのアプリ用パスワードを入力
